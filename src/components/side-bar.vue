  ...
  <div class="vertical-menu">
    <simplebar class="h-100" ref="currentMenu" id="my-element">
      ...
      <div id="sidebar-menu" class="pt-0">
        <!-- Left Menu Start -->
        <ul class="metismenu list-unstyled mb-100" id="side-menu">
...
export default {
  ...
  computed: {
    ...
    filteredMenuItems() {
      const userTypeNum = Number(this.userType);
      return this.menuItems.filter(item => !item.userType || item.userType.includes(userTypeNum))
    }
  },
  mounted() {
