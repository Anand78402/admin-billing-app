    ...
    <ul class="pagination" :class="paginationClass">
        <li class="page-item prev-page" :class="[{ disabled: value === 1 }, prevItemClasses]">
            <a class="page-link" aria-label="Previous" @click="prevPage">
                <slot name="prev"><el-icon class="pagination-icon"><DArrowLeft /></el-icon></slot>
            </a>
        </li>
        <li v-for="item in range(minPage, maxPage)"
:key="item"
class="page-item"
        ...
        <li class="page-item page-pre next-page" :class="[{ disabled: value === totalPages }, nextItemClasses]">
            <a class="page-link" aria-label="Next" @click="nextPage">
                <slot name="next"><el-icon class="pagination-icon"><DArrowRight /></el-icon></slot>
            </a>
        </li>
    </ul>
</template>
